...
For the 1M record seed, it is generated by the `generate_seed.py` Python script in `src/main/resources/db/migration`. By default it will output 2 files: `V12__seed_1m_cases.sql` for SQL seeds, and `seed_mongodb.js` for NoSQL seeds.
